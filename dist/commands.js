 ...
 */
function toggleProtection(_x) {
  return _toggleProtection.apply(this, arguments);
}
function _toggleProtection() {
  _toggleProtection = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(args) {
